# Arrive demo 0808 Configurations

This repository contains all the configuration resources required for the Arrive demo 0808 project to function properly and expose its business features.
